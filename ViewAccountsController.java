    ...
    private void handleTransfer(ActionEvent event) {
        try {
            ...
            if (from.withdraw(amount)) {
                ...
                transactionDAO.record(fromAccNo, "TransferOut", amount, "Transferred to account " + toAccNo);
                transactionDAO.record(toAccNo, "TransferIn", amount, "Received from account " + fromAccNo);
